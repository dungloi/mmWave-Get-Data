...
class RadarConfigHandler:
    ...
    def calcParams(self, cfg_inst) -> None:
        ...
        self.params["Ramp Slope  MHz/us"] = cfg_inst["profileCfg"]["profile_0"]["freqSlopeConst"]
        self.params["Num ADC Samples"] = cfg_inst["profileCfg"]["profile_0"]["numAdcSamples"]
        self.params["ADC Sampling Rate Msps"] = cfg_inst["profileCfg"]["profile_0"]["digOutSampleRate"] / 1000.0

        self.params["ADC Collection Time  us"] = self.params["Num ADC Samples"] / self.params["ADC Sampling Rate Msps"]
        self.params["Extra ramp time required (start time)  us"] = cfg_inst["profileCfg"]["profile_0"]["adcStartTime"]
        ...
        self.params["Chirp duration (end time)  us"] = cfg_inst["profileCfg"]["profile_0"]["rampEndTime"]
        ...
        self.params["Inter-chirp duration  us"] = cfg_inst["profileCfg"]["profile_0"]["idleTime"]
        self.params["Number of chirp intervals in frame"] = (
            cfg_inst["frameCfg"]["chirpEndIdx"] - cfg_inst["frameCfg"]["chirpStartIdx"] + 1
        ...
        self.params["Max extended relative velocity  m/s"] = (
            self.params["Max umambiguous relative velocity  m/s"] * 2 / cfg_inst["frameCfg"]["numLoops"]
        )
